//
//  NowPlayingMoviesListUseCaseTests.swift
//  KueskiMovieDBTests
//
...
final class NowPlayingMoviesListUseCaseTests: XCTestCase {
    ...
    func testExecuteReturnsMovies() async throws {
        ...
        let useCase = NowPlayingMoviesListUseCase(apiClient: mockRepository)
        let queryParams = MoviesQueryParams(nowPlayingMovies: 1)
